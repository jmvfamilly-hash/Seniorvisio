...
def main() -> int:
    ...
    if signalements:
        print("Identifiants sans import repérés :\n")
        for s in signalements:
            print("  " + s)
        print(
            "\nSi l'un d'eux est un faux positif (nom implicite de Kotlin, "
            "générique, membre de la même classe), ajoutez-le à IMPLICITES."
        )
        return 1
