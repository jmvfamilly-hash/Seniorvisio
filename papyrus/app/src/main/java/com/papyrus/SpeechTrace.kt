...
object SpeechTrace {
    ...
    private fun header(): String = buildString {
        ...
        appendLine("                          seulement les lignes figées. Le décalage entre ces")
        appendLine("                          lignes-ci et les « ÉCRAN ligne ajoutée » qui suivent")
        appendLine("                          est le délai d'affichage payé pour cette stabilité :")
        appendLine("                          rien n'apparaît tant que la phrase n'est pas figée.")
        appendLine()
